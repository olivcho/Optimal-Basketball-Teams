Each player evaluated all 14 other players on 6 key basketball skills. Peer evaluations were averaged to produce a feature vector for each player. See "radar charts" for the skill distributions.
